    ...
    <Card className="shadow-xs">
      ...
      <CardContent className="space-y-3">
        ...
        <div className="space-y-1 rounded-md border border-dashed bg-muted/10 px-3 py-2.5">
          <p className="text-muted-foreground text-xs">
            Fastest path: <span className="font-medium text-foreground">-4d cycle</span> recovers
            40% of gap.
          </p>
          <p className="text-muted-foreground text-xs">
            Priority sequence: <span className="text-foreground">cycle time</span> before net-new
            volume.
          </p>
        </div>
      </CardContent>
